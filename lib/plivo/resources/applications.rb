  ...
  module Resources
    ...
    class Application < Base::Resource
      ...
      def update(options = nil)
        ...
        [:answer_url, :hangup_url, :fallback_answer_url, :message_url, :subaccount]
          .each do |param|
        ...
        [:answer_method, :hangup_method, :fallback_method, :message_method]
          .each do |param|
          if options.key?(param) &&
        ...
        [:default_number_app, :default_endpoint_app].each do |param|
          if options.key?(param) &&
